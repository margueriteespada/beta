...
Définition
***************** 
Un objet métier est une entié qui permet d'associer une couche aux attributs d'une table de base de données. De la sorte les attributs associés à une couche sont affichables et éditables. 
